...
// Utilities to make the demo be easier and faster.

import SwiftUI

extension Collection where Element: Identifiable {
    /// Works on any thing that conforms to the Collection protocol.
    // E.g. Sets and arrays.
...
extension String
{
    ...
    func uniqued<StringCollection>(withRespectTo otherStrings: StringCollection) -> String
        ...
        // Constrains and gains. Don't care slightly.
        //StringCollection needs to be conforming to collection thats the Element is a string. Element is also a don't care.
